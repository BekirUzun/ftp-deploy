...
describe("getLocalFiles", () => {
    test("local-dir", () => __awaiter(void 0, void 0, void 0, function* () {
        const localDirDiffs = yield (0, localFiles_1.getLocalFiles)({
            server: "127.0.0.1",
    ...
    test("exclude node_modules", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => (0, utilities_1.applyExcludeFilter)(file, module_1.excludeDefaults));
    ...
    test("exclude none", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => (0, utilities_1.applyExcludeFilter)(file, []));
    ...
    test("exclude all js files", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => (0, utilities_1.applyExcludeFilter)(file, ["*.js"]));
    ...
    test("exclude globbed folder", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => (0, utilities_1.applyExcludeFilter)(file, ["**/folder/**"]));
    ...
    test("exclude existing folder while adding new file", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => (0, utilities_1.applyExcludeFilter)(file, ["test/folder/**"]));
        expect(filteredStats.map(f => f.path)).toStrictEqual(["test/test.js"]);
    }));
});
describe("getDefaultSettings", () => {
    test("path validation", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(() => (0, utilities_1.getDefaultSettings)({
            server: "a",
            username: "b",
            password: "c",
    ...
    test("verify default settings", () => __awaiter(void 0, void 0, void 0, function* () {
        expect((0, utilities_1.getDefaultSettings)({
            server: "a",
            username: "b",
            password: "c",
            ...
            "dry-run": false,
            "dangerous-clean-slate": false,
            exclude: module_1.excludeDefaults,
            "log-level": "standard",
            security: "loose",
            timeout: 30000
        });
    }));
    test("verify default settings override", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((0, utilities_1.getDefaultSettings)(customSettings)).toEqual(customSettings);
    }));
});
describe("error handling", () => {
    test("throws on error", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockedLogger = new MockedLogger();
        const mockedTimings = new utilities_1.Timings();
        const argsWithDefaults = (0, utilities_1.getDefaultSettings)({
            server: "127.0.0.1",
            username: "testUsername",
            password: "testPassword",
            port: 21,
        ...
        yield expect(() => __awaiter(void 0, void 0, void 0, function* () { return yield (0, deploy_1.deploy)(argsWithDefaults, mockedLogger, mockedTimings); })).rejects.toThrow();
    }), 30000);
});
describe("dry-run", () => {
    test("getServerFiles doesn't mutate server", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockedLogger = new MockedLogger();
        const mockedTimings = new utilities_1.Timings();
        const mockClient = {
            clearWorkingDir() { },
        ...
        const settings = (0, utilities_1.getDefaultSettings)({
            server: "a",
            username: "b",
            password: "c",
            "dry-run": true,
        ...
        yield (0, deploy_1.getServerFiles)(mockClient, mockedLogger, mockedTimings, settings);
        expect(spyClearWorkingDir).toHaveBeenCalledTimes(0);
    }));
    test("doesn't mutate server", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockedLogger = new MockedLogger();
        const mockedTimings = new utilities_1.Timings();
        const mockClient = {
            uploadFile() { },
        ...
        // todo ensureDir
        const syncProvider = new syncProvider_1.FTPSyncProvider(mockClient, mockedLogger, mockedTimings, "local-dir/", "server-dir/", "state-name", true);
        ...
        yield syncProvider.syncLocalToServer(mockedDiffs);
...
describe("Deploy", () => {
    ...
    test("Full Deploy", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, deploy_1.deploy)(argsWithDefaults, mockedLogger, mockedTimings);
        ftpServer.close();
    }), 30000);
});
